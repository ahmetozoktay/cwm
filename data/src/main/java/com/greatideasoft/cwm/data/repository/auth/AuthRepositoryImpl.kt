...
class AuthRepositoryImpl @Inject constructor(
	...
	override fun signIn(token: String): Completable = signInWithGoogle(token)
	...
	/**
	 * this fun is called first when user is trying to sign in via google
	 * creates a basic [BaseUserInfo] object based on google profile
	 */
