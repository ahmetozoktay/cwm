...
package com.greatideasoft.cwm.data.repository.cards
...
import com.greatideasoft.cwm.data.core.firebase.asSingle
import com.greatideasoft.cwm.data.core.firebase.deleteAsCompletable
import com.greatideasoft.cwm.data.core.firebase.setAsCompletable
import com.greatideasoft.cwm.data.core.log.logDebug
import com.greatideasoft.cwm.data.core.log.logError
import com.greatideasoft.cwm.data.core.log.logWtf
...
class CardsRepositoryImpl @Inject constructor(
	 ...
	 */
	override fun likeUserAndCheckMatch(user: UserItem, likedUserItem: UserItem): Single<MatchResult> =
		fs.collection(USERS_COLLECTION)
			...
			.flatMap {
				...
				if (it.exists()) {
					...
					).andThen(Single.just(MatchResult(true, conversationId)))
				}
				...
				/** if not exists -> add [likedUserItem] to your liked collection */
					...
					fs.collection(USERS_COLLECTION)
						...
						.toSingle { MatchResult(false) } // no match
				}
			}
