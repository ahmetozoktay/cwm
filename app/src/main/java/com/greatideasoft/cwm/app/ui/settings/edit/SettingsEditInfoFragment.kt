...
package com.greatideasoft.cwm.app.ui.settings.edit
...
import com.greatideasoft.cwm.app.databinding.FragmentSettingsEditInfoBinding
import com.greatideasoft.cwm.app.ui.MainActivity
import com.greatideasoft.cwm.app.ui.common.base.BaseFragment
import com.greatideasoft.cwm.app.ui.common.custom.GridItemDecoration
import com.greatideasoft.cwm.app.ui.settings.SettingsViewModel
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) = binding.run {
		...
		btnSettingsEditSave.setOnClickListener {
			...
			sharedViewModel.updateUser(
				user.copy(
					baseUserInfo = user.baseUserInfo.copy(
						name = newName ?: user.baseUserInfo.name,
						age = newAge ?: user.baseUserInfo.age,
						gender = newGender ?: user.baseUserInfo.gender
					),
					aboutText = newDescription ?: user.aboutText
				)
			)
		}
